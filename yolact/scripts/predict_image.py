...
def args_parser():
    ...
    parser.add_argument('--trained_model', default='weights/yolact_resnet50_54_800000.pth', type=str)
    parser.add_argument('--config', default="yolact_plus_resnet50_config", help='The config object to use.')
...
if __name__ == "__main__":
    ...
    # print(' Done.')
    #
    # frame = torch.from_numpy(cv2.imread(args.images)).cuda().float()
    # batch = FastBaseTransform()(frame.unsqueeze(0))
    # preds = net(batch)
    #
